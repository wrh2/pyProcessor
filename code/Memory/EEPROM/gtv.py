...
def generate_hex(fname):
	...
	MUL = modbv(0x6)[8:]
	MOD = modbv(0x7)[8:]
	instructions = [concat(ADD, modbv(randrange(2**24-1))[24:]),
			concat(SUB, modbv(randrange(2**24-1))[24:]),
			concat(MUL, modbv(randrange(2**24-1))[24:]),
			concat(MOD, modbv(randrange(2**24-1))[24:]),
			concat(ADD, modbv(randrange(2**24-1))[24:]),
			concat(SUB, modbv(randrange(2**24-1))[24:]),
			concat(MUL, modbv(randrange(2**24-1))[24:]),
			concat(MOD, modbv(randrange(2**24-1))[24:]),
			concat(ADD, modbv(randrange(2**24-1))[24:]),
